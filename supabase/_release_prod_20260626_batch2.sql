-- Trainlog release batch 2 (2026-06-26) — run in Supabase SQL Editor, top to bottom.
-- New since the first release: PR cascade + waitlist notify_all. Verified via db reset.

-- ===== 20260626180000_pr_session_cascade =====
-- ============================================================
...
-- ===== 20260626190000_waitlist_notify_all =====
-- ============================================================
