...
const BOX_NAV: NavItem[] = [
  ...
  { href: '/box/book', label: 'Réserver', icon: a => (
    <svg width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={a?2.5:1.8}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M3 8.5A2.5 2.5 0 015.5 6h13A2.5 2.5 0 0121 8.5v1a2 2 0 000 4v1a2.5 2.5 0 01-2.5 2.5h-13A2.5 2.5 0 013 14.5v-1a2 2 0 000-4v-1zM13 7v10" />
    </svg>
  )},
